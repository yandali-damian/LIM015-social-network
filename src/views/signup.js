...
const signup = () => {
    ...
    viewSignup.innerHTML = `<figure class="figure-title">
                                <img class="img-signup" src="./img/warique.png" alt="Title Warique">
                            </figure>
                            ...
                            <figure class="figure-google">
                                <img class="img-google-signup" src="./img/google.png" alt="">
                            </figure>
                            <div>
